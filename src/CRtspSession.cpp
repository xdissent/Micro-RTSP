...
//===========================================================
//===========================================================
CRtspSession::CRtspSession(SOCKET aClient, CStreamer* aStreamer)
...
void CRtspSession::Handle_RtspDESCRIBE() // FIXME: too much redundancy. should eliminate intermediate buffers.
{
    ...
    if (m_Streamer->getURIPresentation() == m_CommandPresentationPart && m_Streamer->getURIStream() == m_CommandStreamPart)
        m_StreamID = 0;
...
bool CRtspSession::handleRequests(uint32_t readTimeoutMs)
{
    ...
    static enum { hdrStateUnknown,
        hdrStateGotMethod,
        hdrStateInvalid } state
        = hdrStateUnknown;
